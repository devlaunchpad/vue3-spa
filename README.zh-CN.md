...
<p align="center">简单纯粹的 Vue3 单页应用项目启动模板</p>
...
基于最新的 Vue3 生态技术打造，不掺杂多余功能和 UI 框架，为开发者提供启动 SPA 项目所需的最佳基础模板。

## 特性

- 基于 Vue3 和 Vite6，集成主流前端生态。
- TypeScript、ESLint、Prettier、Vitest、Cypress 开箱即用。
- 集成 Pinia 状态管理与 Vue I18n 国际化方案。
- Unplugin 插件体系统一管理，实现 Composables、Components、Stores、Routers 自动导入。
- 支持基于文件的路由与布局系统。
- 原生支持 Markdown。
- 支持可选配置 HTTPS，自动生成 SSL 证书。
- ...
